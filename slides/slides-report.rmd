...
La regresión es una técnica que permite generar un modelo lineal en el que el valor de una variable dependiente ($Y$) se determina a partir de un conjunto de variables independientes ($X_{1}, X_{2}, X_{3}, \dots$).

Los modelos de regresión lineal siguen la siguiente ecuación: 

$$
Y = \beta_{0} + \beta_{i} X_{i} + \varepsilon; \quad i = 1, 2, \dots, k
$$
